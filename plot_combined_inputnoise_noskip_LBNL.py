#!/usr/bin/env python3
"""
Script: plot_combined_inputnoise_noskip_LBNL_HX3_thin_bins.py
...
python plot_combined_inputnoise_noskip_LBNL.py --serial_number 20USBHX2002657
"""
...
def main():
    ...
    output_base_dir = args.output or "LBNL/HX3"
