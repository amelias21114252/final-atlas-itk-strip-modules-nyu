...
Usage:
python plot_multi_inputnoise_noskip_LBNL.py -i 'LBNL/HX/SN20USBHX2002099/SN20USBHX2002099_*.json'
python plot_multi_inputnoise_noskip_LBNL.py -i 'LBNL/HX/SN*/*.json'

Output:
LBNL/HX3/SN20USBHX2002301/inputnoise_noskip/SN20USBHX2002301-away.png
LBNL/HX3/SN20USBHX2002301/inputnoise_noskip/SN20USBHX2002301-under.png
'''
...
def mk_inoise_plot(module_name, input_files, stream="under", output_base_dir="LBNL/HX3"):
    ...
    # IMPORTANT:
    # This saves into LBNL/HX3/SERIAL/inputnoise_noskip/
