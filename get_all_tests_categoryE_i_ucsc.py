...
# Run:
# python get_all_tests_categoryE_i_ucsc.py --test_name "Module AMAC IV TC" --max_workers 8
#
# This version reads UCSC ML serial numbers automatically from:
...
def normalize_serial(serial):
    ...
    SN20USBML1236791 -> 20USBML1236791
    20USBML1236791   -> 20USBML1236791
    """
...
def sn_format(serial):
    ...
    20USBML1236791   -> SN20USBML1236791
    SN20USBML1236791 -> SN20USBML1236791
    """
    serial = str(serial).strip()
...
def load_serial_numbers(serial_file):
    """
    Read ML serial numbers from a text file.
    ...
    Only ML serial numbers are kept.
    HX serial numbers are skipped because this is an IV script.
    """
    ...
    if not serial_file.exists():
        raise FileNotFoundError(
            ...
            f"serial_lists/ucsc_ml_serials.txt"
        )
    ...
    if skipped:
        print("=" * 80)
        print("WARNING: skipped non-ML serial numbers from serial file")
        print("=" * 80)
    ...
    if not unique_serial_numbers:
        raise RuntimeError(f"No ML serial numbers found in {serial_file}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run ITkDB Module AMAC IV extraction for UCSC ML serials"
    )
    ...
    parser.add_argument(
        ...
        help="Text file containing UCSC ML serial numbers",
    )
    ...
    print("=" * 80)
    print("UCSC ML IV JSON GENERATION")
    print("=" * 80)
