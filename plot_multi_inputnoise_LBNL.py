...
Usage:
python plot_multi_inputnoise_LBNL.py -i 'LBNL/HX/SN20USBHX2002099/SN20USBHX2002099_*.json'
...
def write_error_summary_txt(output_dir):
    ...
    summary_path = os.path.join(output_dir, "inputnoise_error_summary_lbnl.txt")
...
def main():
    ...
    parser.add_argument(
        "-i",
        "--input",
        help="Glob pattern for JSON files, e.g. 'LBNL/HX/SN*/*.json'",
    )
