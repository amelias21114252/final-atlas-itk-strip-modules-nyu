...
#
# This version reads LBNL HX serial numbers automatically from:
...
def load_serial_numbers(serial_file):
    ...
    if not serial_file.exists():
        raise FileNotFoundError(
            ...
            f"serial_lists/lbnl_hx_serials.txt"
        )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run ITkDB Response Curve TC extraction for LBNL HX serials"
    )
    ...
    parser.add_argument(
        ...
        help="Text file containing LBNL HX serial numbers",
    )
    ...
    print("=" * 80)
    print("LBNL HX INPUT-NOISE JSON GENERATION")
    print("=" * 80)
