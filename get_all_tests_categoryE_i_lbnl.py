...
# Run:
# python get_all_tests_categoryE_i_lbnl.py --test_name "Module AMAC IV TC" --max_workers 8
#
# This version reads LBNL ML serial numbers automatically from:
...
def normalize_serial(serial):
    ...
    SN20USBML1236979 -> 20USBML1236979
    20USBML1236979   -> 20USBML1236979
    """
...
def sn_format(serial):
    ...
    20USBML1236979   -> SN20USBML1236979
    SN20USBML1236979 -> SN20USBML1236979
    """
    serial = str(serial).strip()
...
def load_serial_numbers(serial_file):
    ...
    if not serial_file.exists():
        raise FileNotFoundError(
            ...
            f"serial_lists/lbnl_ml_serials.txt"
        )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run ITkDB Module AMAC IV extraction for LBNL ML serials"
    )
    ...
    parser.add_argument(
        ...
        help="Text file containing LBNL ML serial numbers",
    )
    ...
    print("=" * 80)
    print("LBNL ML IV JSON GENERATION")
    print("=" * 80)
