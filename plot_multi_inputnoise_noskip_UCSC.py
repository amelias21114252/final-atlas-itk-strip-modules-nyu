...
Usage:
python plot_multi_inputnoise_noskip_UCSC.py -i 'UCSC/HX/SN20USBHX2002099/SN20USBHX2002099_*.json'
python plot_multi_inputnoise_noskip_UCSC.py -i 'UCSC/HX/SN*/*.json'

Output:
UCSC/HX3/SN20USBHX2002301/inputnoise_noskip/SN20USBHX2002301-away.png
UCSC/HX3/SN20USBHX2002301/inputnoise_noskip/SN20USBHX2002301-under.png
'''
...
def mk_inoise_plot(module_name, input_files, stream="under", output_base_dir="UCSC/HX3"):
    ...
    # IMPORTANT:
    # This saves into UCSC/HX3/SERIAL/inputnoise_noskip/
...
def main():
    ...
    if args.input:
        ...
        input_files = sorted(glob(f"UCSC/HX/SN{serial_number}/SN{serial_number}_*.json"))
